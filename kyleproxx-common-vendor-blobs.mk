...
ifeq ($(findstring kyleprods,$(TARGET_PRODUCT)),kyleprods)
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/proprietary/lib/libbrcm_ril_KYLEPRODS.so:system/lib/libbrcm_ril.so
else
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/proprietary/lib/libbrcm_ril_KYLEPRO.so:system/lib/libbrcm_ril.so
endif
